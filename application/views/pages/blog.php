<section class="blog-page wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="500ms">
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12 col-lg-8 blog-page-content">
			<?php
			$query_blog = $this->db->query("select * from `blog`");
			foreach ($query_blog->result() as $data) {
				?>
				<div class="wrap-blog-page col-xs-12 clear-padding">
					<a href="blog/detail/<?php echo $data->unique_title_blog;?>" class="link-blog">
						<figure class="wrap-images-blog">
							<img src="<?php echo base_url($data->images_blog);?>" />
							<figcaption><?php echo $data->title_blog;?></figcaption>
						</figure>
						<div class="col-xs-12 date-and-by">
